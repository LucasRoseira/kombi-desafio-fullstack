<section id="logistica" class="container text-center mt-2">
    ...
    <div class="gallery-box p-4 pt-2 pb-2 mx-auto">
        <h3 class="gallery-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vehicula</h3>
        <p class="gallery-text mt-3">
            ...
            Integer vulputate, est ac molestie tempus, sem nunc ultricies odio, et tristique purus lacus ac leo. Proin
            scelerisque ultricies ultricies. Curabitur suscipit tempus nisl, tempus mollis odio lobortis at.
        </p>
    </div>
